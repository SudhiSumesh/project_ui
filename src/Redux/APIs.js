export const Apis = {
  ...
  Accounts_statementListApi: 'trillium-clinic-service/v1/account/statement/list',
  Accounts_getStatementsDetailsApi: 'trillium-clinic-service/v1/account/statement/details',
  ...
  Accounts_stripePaymentApi: 'trillium-clinic-service/v1/payment/patient/stripe/',
  ...
  Dashboard_getReceivableGross: "trillium-clinic-service/v1/dashboard/getARGross",
  ...
  Production_prodClaimDownloadApi: 'trillium-internal-service/v1/coderPortal/download',
  ...
  //PriorAuth
  Priorauth_priorAuthListApi: 'trillium-internal-service/v1/priorAuth/list/range',
  ...
  Priorauth_priorAuthSaveApi: 'trillium-internal-service/v1/priorAuth/addTestProcedureDetails',
  Priorauth_loginInfoApi: 'trillium-internal-service/v1/common/priorAuth/cache?applicationId=4',
  ...
  Priorauth_mappingListApi: 'trillium-internal-service/v1/common/external/mapping/list',
  Priorauth_saveMappingApi: 'trillium-internal-service/v1/common/external/mapping/'
}